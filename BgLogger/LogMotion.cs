...
/// <summary>
/// 提供用于记录运动控制相关信息的静态日志方法.
/// </summary>
public class LogMotion : IBgLogger
{
    /// <summary>
    /// 将 Trace 级别的日志记录到 Motion 日志源.
    /// </summary>
    ...
    /// <summary>
    /// 将带异常信息的 Trace 级别日志记录到 Motion 日志源.
    /// </summary>
    ...
    /// <summary>
    /// 将带异常信息的 Debug 级别日志记录到 Motion 日志源.
    /// </summary>
    /// <param name="ex">要记录的异常.</param>
    /// <param name="format">带格式项的日志消息.</param>
    /// <param name="args">格式化参数数组.</param>
    ...
    /// <summary>
    /// 将带异常信息的 Info 级别日志记录到 Motion 日志源.
    /// </summary>
    /// <param name="ex">要记录的异常.</param>
    /// <param name="format">带格式项的日志消息.</param>
    /// <param name="args">格式化参数数组.</param>
    ...
    /// <summary>
    /// 将带异常信息的 Warn 级别日志记录到 Motion 日志源.
    /// </summary>
    /// <param name="ex">要记录的异常.</param>
    /// <param name="format">带格式项的日志消息.</param>
    /// <param name="args">格式化参数数组.</param>
    ...
    /// <summary>
    /// 将带异常信息的 Error 级别日志记录到 Motion 日志源.
    /// </summary>
    ...
    /// <summary>
    /// 将带异常信息的 Fatal 级别日志记录到 Motion 日志源.
    /// </summary>
    /// <param name="ex">异常对象（可选）.</param>
    /// <param name="format">日志消息 或格式化日志消息.</param>
    /// <param name="args">格式化参数.</param>
